...
<div class="sidebar">
  ...
  <pre> </pre>
  <a href="dashboard_manager.php"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
    ...
    <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-6 w-full max-w-6xl">
      ...
      <div class="flex items-center p-4 bg-white rounded">
        ...
        <div class="flex-grow flex flex-col ml-4">
          <span class="text-xl font-bold">Manager Task 1</span>
          <div class="flex items-center justify-between">
            <span class="text-gray-500">Description of Manager Task 1</span>
          </div>
        </div>
      </div>
      <!-- Tile 2 -->
      <div class="flex items-center p-4 bg-white rounded">
        ...
        <div class="flex-grow flex flex-col ml-4">
          <span class="text-xl font-bold">Manager Task 2</span>
          <div class="flex items-center justify-between">
            <span class="text-gray-500">Description of Manager Task 2</span>
          </div>
        </div>
      </div>
      <!-- Tile 3 -->
      <div class="flex items-center p-4 bg-white rounded">
        ...
        <div class="flex-grow flex flex-col ml-4">
          <span class="text-xl font-bold">Manager Task 3</span>
          <div class="flex items-center justify-between">
            <span class="text-gray-500">Description of Manager Task 3</span>
          </div>
        </div>
      </div>
    </div>
